...
var winwid = $(window).width();
	if(winwid<990){
		...
		$('.aboutus .desc ').css('margin-left','8px')
	}
   ...
   $('.nav-content ul li').click(function(e){
		...
		window.location.href='http://'+window.location.host+'/'+dataid+'.html';
  ...
  /* 	var hei1 = $('.aboutus').height()+50;
   ...
   $('.texas_content .more').click(function(){
  	 	window.location.href='http://'+window.location.host+'/texadetail.html';
   })
